...
# =====                     plot2.R
# ===== This routine constructs a line chart of household global minute-averaged
...
# ===== The plot file name is plot2.png
# =====
...
with(hhpow, plot(datetime,Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)" ))
